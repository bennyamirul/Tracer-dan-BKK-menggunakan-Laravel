...
class ProfileController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        if ($section === 'tracer') {
            ...
            return redirect()->route('profile.edit', ['tab' => 'tracer'])
                ->with('status', 'Tracer alumni berhasil diperbarui')
                ->with('activeTab', 'tracer');
        }

        // Default: update data diri
        $validated = $request->validate([
        ...
        return redirect()->route('profile.edit')->with('status', 'Profil berhasil diperbarui')->with('activeTab', 'data');
    }
