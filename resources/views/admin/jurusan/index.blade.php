    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                ...
                <span class="text-muted mt-1 fw-semibold fs-7">Total {{ $jurusans->count() }} jurusan</span>
            </h3>
            ...
            <div class="modal fade"
                id="addJurusanModal"
                tabindex="-1"
                aria-labelledby="addJurusanModalLabel"
                aria-hidden="true"
                data-modal-form
                data-error-text="Maaf, sepertinya ada beberapa kesalahan yang terdeteksi, silakan coba lagi."
                data-cancel-text="Apakah Anda yakin ingin membatalkan penambahan jurusan?">
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    <div class="modal-content rounded">
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            <!--begin:Form-->
                            <form id="kt_modal_add_jurusan_form" action="{{ route('admin.jurusan.store') }}" method="POST" class="form">
                                @csrf
                                <!--begin::Heading-->
                                <div class="mb-13 text-center">
                                    ...
                                    <!--end::Title-->
                                    <!--begin::Description-->
                                    <div class="text-muted fw-semibold fs-5">Silakan masukkan informasi jurusan yang akan ditambahkan</div>
                                    <!--end::Description-->
                                </div>
                                <!--end::Heading-->
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                        <span class="required">Kode Jurusan</span>
                                        <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Masukkan kode unik untuk jurusan"></i>
                                    </label>
                                    <!--end::Label-->
                                    <input type="text"
                                        class="form-control form-control-solid @error('kode') is-invalid @enderror"
                                        placeholder="Contoh: TI, SI, RPL"
                                        name="kode"
                                        id="jurusanCode"
                                        value="{{ old('kode') }}"
                                        data-validate='{"notEmpty":{"message":"Kode jurusan harus diisi"},"stringLength":{"min":2,"max":16,"message":"Kode jurusan harus antara 2-16 karakter"}}' />
                                    @error('kode')
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <input type="text"
                                        ...
                                        id="jurusanName"
                                        value="{{ old('nama') }}"
                                        data-validate='{"notEmpty":{"message":"Nama jurusan harus diisi"},"stringLength":{"min":3,"max":100,"message":"Nama jurusan harus antara 3-100 karakter"}}' />
                                    @error('nama')
                                    <div class="fv-plugins-message-container invalid-feedback">
                                        <div>{{ $message }}</div>
                                    </div>
            ...
            <div class="modal fade"
                id="editJurusanModal"
                tabindex="-1"
                aria-labelledby="editJurusanModalLabel"
                aria-hidden="true"
                data-modal-form
                data-modal-edit
                data-error-text="Maaf, sepertinya ada beberapa kesalahan yang terdeteksi, silakan coba lagi."
                data-cancel-text="Apakah Anda yakin ingin membatalkan perubahan jurusan?">
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    <div class="modal-content rounded">
                        <!--begin::Modal header-->
                        <div class="modal-header pb-0 border-0 justify-content-end">
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            <!--begin:Form-->
                            <form id="kt_modal_edit_jurusan_form"
                                action=""
                                method="POST"
                                class="form"
                                data-action-template="{{ route('admin.jurusan.update', ':id') }}">
                                @csrf
                                @method('PUT')
                                <!--begin::Heading-->
                                <div class="mb-13 text-center">
                                    ...
                                    <!--end::Title-->
                                    <!--begin::Description-->
                                    <div class="text-muted fw-semibold fs-5">Perbarui informasi jurusan</div>
                                    <!--end::Description-->
                                </div>
                                <!--end::Heading-->
                                <!--begin::Alert for errors-->
                ...
                <table id="kt_datatable_example_1" class="table table-hover align-middle gs-0 gy-4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge badge-light-primary fs-7 fw-bold">{{ $jurusan->kode }}</span>
                            </td>
                            <td>
                                <div class="d-flex flex-column">
                                    <span class="text-dark fw-bold text-hover-primary fs-6 text-capitalize">{{ $jurusan->nama }}</span>
                                    <span class="text-muted fw-semibold text-muted d-block fs-7">Dibuat: {{ $jurusan->created_at->format('d M Y') }}</span>
                                </div>
                            </td>
                            <td class="text-end pe-3">
                                ...
                                <form action="{{ route('admin.jurusan.destroy', $jurusan->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus jurusan ini?');">
                                    @csrf
                                    @method('DELETE')
