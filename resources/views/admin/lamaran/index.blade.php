    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3 mt-3 px-5 px-md-8">
            <div class="position-relative w-100 w-md-auto">
                ...
                <input type="text" id="searchInput" class="form-control form-control-solid w-100 w-md-250px ps-14" placeholder="Cari lamaran...">
            </div>
        </div>
        <!--end::Search Box-->
        <!--begin::Body-->
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end pe-4">
                                <a href="{{ route('admin.profile-user.show', $item->user->id) }}"
                                ...
                                <a href="{{ route('admin.lamaran.show-lowongan', $item->id) }}"
                                ...
                                <a href="{{ route('admin.lamaran.edit', $item->id) }}"
