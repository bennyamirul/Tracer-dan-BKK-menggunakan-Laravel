    ...
    <div class="card mb-5 mb-xl-8">
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    <div class="modal-content rounded">
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            <!--begin:Form-->
                            <form id="kt_modal_add_lowongan_form" action="{{ route('admin.lowongan.store') }}" method="POST" class="form">
                                @csrf
                                <!--begin::Heading-->
                    ...
                    <div class="modal-content rounded">
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            ...
                            <form id="kt_modal_edit_lowongan_form"
                                ...
                                method="POST"
                                class="form"
                                data-action-template="{{ route('admin.lowongan.update', ':id') }}">
                                @csrf
                                @method('PUT')
                                <!--begin::Heading-->
                                <div class="mb-13 text-center">
                                    <!--begin::Title-->
                                    <h1 class="mb-3">Edit dLowongan Kerja</h1>
                                    <!--end::Title-->
                                    <!--begin::Description-->
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3 mt-3 px-5 px-md-8">
            <div class="position-relative w-100 w-md-auto">
                ...
                <input type="text" id="searchInput" class="form-control form-control-solid w-100 w-md-250px ps-14" placeholder="Cari Lowongan Kerja...">
            </div>

            <div class="card-toolbar w-100 w-md-auto">
                <!-- Tombol untuk membuka Modal -->
                <button type="button" class="btn btn-sm btn-primary w-100 w-md-auto" data-bs-toggle="modal" data-bs-target="#addLowonganModal">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end pe-4">
                                <a href="{{ route('admin.lowongan.show', $item->id) }}"
                                ...
                                <form action="{{ route('admin.lowongan.destroy', $item->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus Lowongan Kerja ini?');">
                                    @csrf
                                    @method('DELETE')
