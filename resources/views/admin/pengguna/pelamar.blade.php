    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                ...
                <span class="text-muted mt-1 fw-semibold fs-7">Total {{ $pelamars->where('role', 'pelamar_alumni')->count() }} Pelamar Alumni dan {{ $pelamars->where('role', 'pelamar_umum')->count() }} Pelamar Umum</span>
            </h3>
            ...
            <div class="modal fade"
                id="addPelamarModal"
                tabindex="-1"
                aria-labelledby="addPelamarModalLabel"
                aria-hidden="true"
                data-modal-form
                data-error-text="Maaf, sepertinya ada beberapa kesalahan yang terdeteksi, silakan coba lagi."
                data-cancel-text="Apakah Anda yakin ingin membatalkan penambahan Pelamar?">
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    <div class="modal-content rounded">
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            <!--begin:Form-->
                            <form id="kt_modal_add_pelamar_form" action="{{ route('admin.pelamar.store') }}" method="POST" class="form" enctype="multipart/form-data">
                                @csrf
                                <!--begin::Heading-->
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                        <span class="required">Nama Pelamar</span>
                                        <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Masukkan nama lengkap Pelamar"></i>
                                    </label>
                                    <!--end::Label-->
                                    <input type="text"
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    <!--begin::Label-->
                                    <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                        <span class="required">Jenis Pelamar</span>
                                        <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Masukkan Jenis Pelamar"></i>
                                    </label>
                                    <!--end::Label-->
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    <!--begin::Label-->
                                    <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                        <span class="required">Email Pelamar</span>
                                        <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Masukkan Email Pelamar"></i>
                                    </label>
                                    <!--end::Label-->
                                    <input type="text"
                                        ...
                                        id="email"
                                        value="{{ old('email') }}"
                                        data-validate='{"notEmpty":{"message":"Email Pelamar harus diisi"},"email":{"message":"Email Pelamar tidak valid"}}' />
                                    @error('email')
                                    <div class="fv-plugins-message-container invalid-feedback">
                                        <div>{{ $message }}</div>
                                    </div>
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    <!--begin::Label-->
                                    <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                        <span class="required">Password Pelamar</span>
                                        <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Masukkan Password Pelamar"></i>
                                    </label>
                                    <input type="password"
                                        class="form-control form-control-solid @error('password') is-invalid @enderror"
                                        placeholder="Contoh: Password Pelamar"
                                        name="password"
                                        id="password"
                                        value="{{ old('password') }}"
                                        data-validate='{"notEmpty":{"message":"Password Pelamar harus diisi"},"stringLength":{"min":8,"max":150,"message":"Password Pelamar minimal 8 karakter"}}' />
                                    @error('password')
                                    <div class="fv-plugins-message-container invalid-feedback">
                                        <div>{{ $message }}</div>
                                    </div>
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    <!--begin::Label-->
                                    <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                        <span class="required">Konfirmasi Password Pelamar</span>
                                    ...
                                    <input type="password"
                                        ...
                                        data-validate='{"notEmpty":{"message":"Konfirmasi Password Pelamar harus diisi"},"stringLength":{"min":8,"max":150,"message":"Konfirmasi Password Pelamar"}}' />
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    <!--begin::Label-->
                                    <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                        <span class="required">Status Pelamar</span>
                                    </label>
                                    <select
        ...
        <div class="card-body py-3">
            ...
            <div class="table-responsive">
                ...
                <table id="kt_datatable_example_1" class="table table-hover align-middle gs-0 gy-4">
                    ...
                    <!--begin::Table body-->
                    <tbody>
                        @forelse ($pelamars as $index => $item)
                        <tr>
                            ...
                            <td class="text-end pe-3">
                                <a href="{{ route('admin.profile-user.show', $item->id) }}"
                                ...
                                <a href="{{ route('admin.profile-user.edit', $item->id) }}"
                                ...
                                <form action="{{ route('admin.pelamar.destroy', $item->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus Pelamar ini?');">
                                    @csrf
                                    @method('DELETE')
