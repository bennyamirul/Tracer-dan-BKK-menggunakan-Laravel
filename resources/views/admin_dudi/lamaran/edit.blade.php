    ...
    <div class="card mb-5">
        ...
        <div class="card-body py-4">
            ...
            <div class="mb-10">
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        <span class="text-muted">Email Pelamar</span>
                    </div>
                    <div class="col-md-9">
                        <span class="fw-bold">{{ $lamaran->user->email }}</span>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-3">
            ...
            <!--begin::Form-->
            <form action="{{ route('admin_dudi.lamaran.update', $lamaran->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{ route('admin_dudi.lamaran.index') }}" class="btn btn-light me-3">Batal</a>
