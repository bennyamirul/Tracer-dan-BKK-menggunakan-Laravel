<div id="kt_aside" class="aside aside-light aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
    <div class="aside-logo flex-column-auto" id="kt_aside_logo">
        <a href="{{ route('admin_dudi.dashboard') }}">
    ...
    <div class="aside-menu flex-column-fluid">
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                <div class="menu-item">
                    <a class="menu-link {{ request()->routeIs('admin_dudi.dashboard') ? 'active' : '' }} " href="{{ route('admin_dudi.dashboard') }}">
                        ...
                        <span class="menu-title fw-bold fs-6 text-capitalize">Dashboard</span>
                    </a>
                </div>
                <div class="menu-item">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ request()->routeIs('admin_dudi.lowongan.index') ? 'active' : '' }} " href="{{ route('admin_dudi.lowongan.index') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-1">
                        ...
                        <span class="menu-title fw-bold fs-6 text-capitalize">Lowongan Kerja</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link {{ request()->routeIs('admin_dudi.lamaran.index') ? 'active' : '' }} " href="{{ route('admin_dudi.lamaran.index') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <span class="menu-title fw-bold fs-6 text-capitalize">Data Lamaran</span>
                    </a>
                </div>
                <div class="menu-item">
                    <div class="menu-content pb-2">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ request()->routeIs('admin_dudi.profile') ? 'active' : '' }} " href="{{ route('admin_dudi.profile') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
