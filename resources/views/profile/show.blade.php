...
<div class="container py-10">
    <!--begin::Profile Header ala Metronic-->
        ...
        <div class="card-body pt-9 pb-0">
            ...
            <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                ...
                <div class="flex-grow-1">
                    ...
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
                                ...
                                @if($user->no_telp)
                                <span class="d-flex align-items-center text-gray-600 me-5 mb-2">
                                    <i class="fa-solid fa-phone me-2"></i>{{ $user->no_telp }}
                                </span>
                                @endif
                                @if($user->alamat)
                                <span class="d-flex align-items-center text-gray-600 mb-2">
                                    <i class="fa-solid fa-location-dot me-2"></i>{{ $user->alamat }}
                                </span>
                                @endif
                            </div>
                            <!--end::Info-->
                    ...
                    <!--end::Title-->
                    <!--begin::Stats (opsional sederhana)-->
    ...
    <!--begin::Card gabungan Tabs + Content-->
    <div class="card shadow-sm mb-5 mb-xl-10">
                ...
                <div class="tab-pane fade" id="tab-berkas" role="tabpanel">
                    ...
                    <div class="p-0">
                        ...
                        <div class="d-flex align-items-center justify-content-between border rounded p-4 mb-3">
                            <div class="d-flex align-items-center">
                                <span class="badge badge-light me-4 p-4"><i class="fa-regular fa-file-lines"></i></span>
                                <div>
                                    <div class="fw-bolder">{{ $b->jenis }}</div>
                                    <div class="text-muted small">{{ $b->created_at->format('d M Y') }}</div>
                                </div>
                            </div>
                            <a href="{{ asset('storage/' . $b->file_path) }}" target="_blank" class="btn btn-sm btn-light">Lihat</a>
                        </div>
                        @empty
